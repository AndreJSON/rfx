...
- The recipe list is grouped into labeled sections in this exact order: **Varmrätt**, **Efterrätt**, **Bakat**, **Övrigt**.
- A recipe appears in **Varmrätt**, **Efterrätt**, and/or **Bakat** when it has the corresponding tag, and it may appear in multiple of these sections.
...
- Tag input triggers tag creation on Enter, comma, or space.
